...
class TestQuestionAnswer:
    def setup_method(self):
        nodes = [("Question", Delimeter("?::"), "Answer")]
...
class TestAnswerQuestion:
    def setup_method(self):
        nodes = [("Answer", Delimeter("::?"), "Question")]
...
class TestNestedSingleLevel:
    def setup_method(self):
        nodes = [("Header", [("Question 1", Delimeter("?::"), "Answer 1")])]
...
class TestNestedMultipleLevels:
    def setup_method(self):
        nodes = [
            ("Header 1", [("Header 2", [("Question 1", Delimeter("?::"), "Answer 1")])])
        ]
...
class TestNestedStandaloneQuestion:
    def setup_method(self):
        nodes = [("Header 1", [("Answer", [(Delimeter("::?"), "Question")])])]
...
class TestNestedStandaloneAnswer:
    def setup_method(self):
        nodes = [("Header 1", [("Question", [(Delimeter("?::"), "Answer")])])]
...
class TestNestedStandaloneTwoWay:
    def setup_method(self):
        nodes = [("Header 1", [("Side 1", [(Delimeter("::"), "Side 2")])])]

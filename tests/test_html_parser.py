...
class TestIsHeaderWithEqualOrHigherLevel:
    ...
    def test_h2_vs_h3(self):
        assert is_descendant('h2', self.header) == \
            True
    
    def test_h3_vs_h3(self):
        assert is_descendant('h3', self.header) == \
            False

    def test_h4_vs_h3(self):
        assert is_descendant('h4', self.header) == \
            False
...
class TestList:
    ...
    def test_list_with_html(self):
        ...
        assert [("A <i>italic</i>", Delimeter("::"), "B <strong>strong</strong>")] == \
            nodes
...
class TestImages:
    def test_strips_path_from_image(self):
        ...
        assert [("Question", Delimeter("?::"), "Answer <img src=\"bar.png\"/>")] == \
            nodes
